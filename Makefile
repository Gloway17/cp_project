...
SERVER_SRCS = src/server/server.c src/server/user_auth.c src/server/crypto_sha.c src/server/server_log.c
...
secure_client:
	$(CC) $(CFLAGS) -o $(BIN_DIR)/secure_client $(CLIENT_SRCS) -lpthread
